...
<!-- your webpage info goes here -->
	...
	<meta name="description" content="SP Home Page" />
...
<!-- webpage content goes here in the body -->
	...
	<div id="page">
		...
		<div id="content">
			<h2>SP Landing page</h2>
			<p>
				This is a page at service provider to show received SAML response: </p><br>
			<b><%=request.getAttribute("originalResponse").toString().replace("<", "&lt;").replace(">", "&gt;") %></b>
		</div>
		<div id="footer">
			<p>
